...
![Search Devops](../../definitive-hc/azure-pipelines-cicd/images/search-azure-devops.png)

![My orgs](../../definitive-hc/azure-pipelines-cicd/images/My-orgs.png)

2. You can create a new organiztion choose an existing one. 
![Create new Org](../../definitive-hc/azure-pipelines-cicd/images/new-org.png)

3. Create a new project, choose *Private Visibility*.
![new-project](../../definitive-hc/azure-pipelines-cicd/images/new-project.png)
![Search Devops](../../definitive-hc/azure-pipelines-cicd/images/project-visibility.png)



4. Open the project and navigate to **Pipelines -> library**.

![open library](../../definitive-hc/azure-pipelines-cicd/images/open-library.png)
...
```
![Create vars](../../definitive-hc/azure-pipelines-cicd/images/create-vars.png)

6. To create a new pipeline navigate to Pipelines -> Pipelines and click on **New Pipeline**.

[Open pipeline](../../definitive-hc/azure-pipelines-cicd/images/open-pipelines.png)

[New pipeline](../../definitive-hc/azure-pipelines-cicd/images/new-pipeline.png)

7. Setup Pipeline

    - Connect: Select your 'Repository Type 
      ![repo type](../../definitive-hc/azure-pipelines-cicd/images/connect-github.png)

    - Select: Select the repository that you had previously connected the ADF with.
      ![select repo](../../definitive-hc/azure-pipelines-cicd/images/pipeline-select-repo.png)

    - Configure: Select **Existing Azure Pipelines YAML file** 
      ![select existing yaml](../../definitive-hc/azure-pipelines-cicd/images/select-existingyaml-options.png)
...
![update subscription step 4](../../definitive-hc/azure-pipelines-cicd/images/update-subscription.png)
![update subscription step 5](../../definitive-hc/azure-pipelines-cicd/images/update-subscription-2.png)
